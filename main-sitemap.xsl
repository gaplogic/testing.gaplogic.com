			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Ubicaciones del mapa del sitio - TESTING &#8211; GAPLOGIC | Agencia de Marketing y Diseño Web en Sitges</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Mapa del sitio XML - TESTING &#8211; GAPLOGIC | Agencia de Marketing y Diseño Web en Sitges</title>
					</xsl:otherwise>
				</xsl:choose>
